System.config({
  ...
  map: {
    ...
    "karma-mocha": "npm:karma-mocha@1.3.0",
    "mocha": "npm:mocha@3.4.2",
    "mocha-typescript": "npm:mocha-typescript@1.1.7",
